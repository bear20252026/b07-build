...
export function AgencyRoleCatalogPage({ gatewayAttached, onBack }: { gatewayAttached: boolean; onBack: () => void }) {
  ...
  useEffect(() => { load(); // 仅在三级目录被主动打开且 Gateway 已附着时读取。
