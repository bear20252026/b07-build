...
export const catalog = {
  'zh-CN': {
    ...
    task: {
      ...
      welcomeEyebrow: 'NOVA · THIRD-PARTY API',
    ...
    home: {
      ...
      title: '今天想推进什么成果？',
      description: '选择一个工作方式，输入目标；模型、审计与运行记录都在设置中按需管理。',
      profileLabel: '选择工作方式',
      ...
      suggestions: ['为本项目生成一个可恢复的实现计划', '梳理当前任务产生的文件并准备交付', '分析一个需求并列出需要人工确认的步骤'],
    },
    insights: {
      aria: '控制面洞察',
      eyebrow: '受控运行时',
  ...
  en: {
    ...
    navigation: {
      ...
      settingsSubtitle: 'Settings & connections',
    ...
    home: {
      eyebrow: 'NOVA · THIRD-PARTY API',
      title: 'What outcome will you move forward today?',
      description: 'Choose a working mode and describe the goal. Models, audits, and run records stay available on demand in Settings.',
      ...
      suggestions: ['Create a recoverable implementation plan for this project', 'Review task-scoped files and prepare a delivery package', 'Analyze a request and identify steps requiring human confirmation'],
    },
    insights: {
