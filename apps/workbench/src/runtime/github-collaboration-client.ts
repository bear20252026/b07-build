...
export interface GithubWorkspacePreflight { readonly passed: boolean; readonly command: 'git diff --check'; readonly detail: string; }
...
export const githubCollaborationClient = Object.freeze({
  ...
  preflight: (): Promise<GithubWorkspacePreflight> => invoke('github_workspace_preflight'),
