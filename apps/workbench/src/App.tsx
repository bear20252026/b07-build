...
export function App() {
  ...
  const pageTitle: Record<WorkbenchPage, string> = { workspace: messages.task.title, projects: '项目', task: '当前任务', models: '模型连接', connections: '已连接模型', operations: '运行记录', 'api-usage': 'API 使用审计', capabilities: '扩展与能力', 'agency-roles': '预置专业角色', security: '安全与系统' };
